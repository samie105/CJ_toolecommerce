        ...
        <div className="w-full max-w-md space-y-8">
          ...
          >
            ...
            <p className="text-muted-foreground">
              Join our community of professional craftsmen
            </p>
          </motion.div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Social signup is currently under maintenance and will be back soon. 
      ...
      <div className="hidden lg:block relative bg-foreground/5">
        ...
        >
          ...
          <p className="text-lg text-white/80 max-w-xl">
            Experience the difference that professional-grade equipment makes. Join our community and elevate your craft.
          </p>
        </motion.div>
      </div>
    </div>
